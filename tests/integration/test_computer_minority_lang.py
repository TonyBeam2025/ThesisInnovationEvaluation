...
def test_computer_application_thesis():
    """测试计算机应用技术论文"""
    print("🖥️ 测试计算机应用技术学位论文目录提取")
    ...
    try:
        ...
        if result and result.entries:
            ...
            for i, entry in enumerate(result.entries, 1):
                ...
                confidence_info = f"置信度: {entry.confidence:.2f}" if hasattr(entry, 'confidence') else ""
                
                print(f"{i:2d}. {type_label} {entry.title}")
                print(f"     {page_info} | 级别: {entry.level} | {confidence_info}")
...
def test_minority_language_thesis():
    """测试中国少数民族语言文学论文"""
    print("\n\n📚 测试中国少数民族语言文学学位论文目录提取")
    doc_path = r"c:\MyProjects\thesis_Inno_Eval\data\input\1_18210104022_公太加_中国少数民族语言文学_藏族民间长歌研究.docx"
    print(f"📁 文件: {os.path.basename(doc_path)}")
    print("=" * 80)
...
def check_raw_content():
    ...
    docs = [
        (r"c:\MyProjects\thesis_Inno_Eval\data\input\1_计算机应用技术_17211204005-苏慧婧-基于MLP和SepCNN模型的藏文文本分类研究与实现-计算机应用技术-群诺.docx", "计算机应用技术"),
        (r"c:\MyProjects\thesis_Inno_Eval\data\input\1_18210104022_公太加_中国少数民族语言文学_藏族民间长歌研究.docx", "中国少数民族语言文学")
    ]
    ...
    try:
        ...
        for doc_path, doc_type in docs:
            ...
            targets = ["致谢", "谢辞", "个人简历", "攻读", "学术成果", "参考文献", "附录", "目录"]
...
if __name__ == "__main__":
    test_computer_application_thesis()
    test_minority_language_thesis()
    check_raw_content()
