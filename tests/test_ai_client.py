...
"""
import pytest
pytest.skip("gemini client integration test requires optional module", allow_module_level=True)
...
try:
    from thesis_inno_eval.gemini_client import get_ai_client, ai_client_context, ConcurrentAIClient
